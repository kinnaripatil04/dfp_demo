                ...
                <div class="mission-container container">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">Parent Name 1</th>
                            <th scope="col">Parent Name 2</th>
                            <th scope="col">Parent 1 Gender</th>
                            <th scope="col">Parent 2 Gender</th>
                            <th scope="col">Parent 1 DOB</th>
                            <th scope="col">Parent 1 DOB</th>
                            <th scope="col">Parent 1 Address</th>
                            <th scope="col">Parent 1 Address</th>
                            <th scope="col">Parent 1 Pincode</th>
                            <th scope="col">Parent 2 Pincode</th>
                        </tr>
                        </thead>
                        <tbody>
                            <?php 
...
if($total!=0){
    ...
    while(($result=mysqli_fetch_assoc($data))){
        echo "
        <tr>
        <td>".$result['r_firstname']."</td>
        <td>".$result['r_lastname']."</td>
        <td>".$result['r_email']."</td>
        <td>".$result['r_phone']."</td>
        <td>".$result['r_p1name']."</td>
        <td>".$result['r_p2name']."</td>
        <td>".$result['r_p1gender']."</td>
        <td>".$result['r_p2gender']."</td>
        <td>".$result['r_p1dob']."</td>
        <td>".$result['r_p2dob']."</td>
        <td>".$result['r_p1address']."</td>
        <td>".$result['r_p2address']."</td>
        <td>".$result['r_p1pincode']."</td>
        <td>".$result['r_p2pincode']."</td>
        </tr>
        ";
    }
